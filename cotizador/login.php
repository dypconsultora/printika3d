...
<body>
  <form class="login-card" method="post" autocomplete="off">
    <a href="https://printika3d.com">
      <img src="../assets/Innovacion-en-3D.svg" alt="Printika 3D" class="login-logo logo-light">
      <img src="../assets/Innovacion-en-3D-dark.svg" alt="Printika 3D" class="login-logo logo-dark">
    </a>
